...
const HeroSection = () => {
    ...
    return (
        <div className="d-flex align-items-center mb-5 mx-auto border-0 flex-row" id="home" >
            <div className="container-fluid d-flex has-blur justify-content-center  py-5" style={{ minHeight: '100vh'}}>
                <div className="row align-items-center mt-5 pt-5">
                    <div className="col-lg-5 px-5 pl-lg-0 pb-5 pb-lg-0">
                        <img className="img-fluid w-100 rounded-circle shadow-sm" src={Images.myPic} alt="" />
                    </div>
                    {/* <span className="vr"></span> */}
                    <div className="col-lg-7 text-lg-left d-flex flex-column align-items-center my-3 ">
                        <div className="my-4">
                            <h3 className="text-white  font-weight-normal d-inline p-2    px-3 bg-oxford rounded-pill " style={{width: "max-content"}}>👋 H'lo there</h3>
                            <h3 className="text-dark font-weight-normal  d-inline p-2  my-0  px-3 bg-light rounded-pill " style={{width: "max-content"}}>I'm</h3>
                        </div>
                        <h1 className="display-3 fw-bolder text-uppercase text-primary mb-2 has-stroke" style={{ fontWeight: 900 }}>BISHIR  T.M</h1>

                        {/* Add an element for Typed.js output */}
                        <div className='h-100 text-white fs-3 text-capitalise'> 
                          <span  className='w-100 lead text-white fs-3 text-capitalise' id="typed-output"> </span>
