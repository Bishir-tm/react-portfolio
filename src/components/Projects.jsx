...
const projectsData = [
  {
    ...
    image: {
      path: "./images/viruseer.png",
      width: "600",
      height: "",
      alt: "Viruseer "
    },
    description: [
      "Viruseer is a robust multi-file type online virus scanner that allows you to scan files for viruses",
    ...
    links: {
      github: "https://www.bishir-tm.github.io/viruseer",
      website: "https://viruseer.web.app"
    },
  ...
  },
  {
    ...
    image: {
      path: "./images/drug-basket.png",
      width: "",
      height: "",
      alt: "Drug Basket "
    },
    description: [
      "Allows you to search and obtain information of over 4,000 drugs  ",
      "Get safety alerts, warnings, of drugs you use everyday",
      "Simple and minimal intuitive UI ",
      ""
    ],
    links: {
      github: "https://www.bishir-tm.github.io/drug-basket",
      website: "https://medication-alert-system.web.app"
    },
    frontendTechnologies: [
      "HTML",
      "CSS",
  ...
  },
  {
    ...
    subtitle:
      "REST API for verification and authentication of Credit & Debit Cards ",
    image: {
      path: "./images/drug-basket.png",
      width: "",
      height: "",
    ...
    description: [
      'The API allows you to verify and authenticate "Verve", "Mastercard", and "Visa-Card" credit and debit cards',
    ...
    links: {
      github: "https://www.bishir-tm.github.io/drug-basket",
      website: "https://medicationalertsystem.web.app"
    },
  ...
  },
  {
    ...
    subtitle: "360° online file virus scanner",
    image: {
      path: "./images/bi-bot.png",
      width: "",
      height: "",
      alt: "Bi-Bot CryptoCurrency Trading Bot "
    },
    description: [
      "A robust and scalable cryptocurrency trading bot capable of executing buy and sell orders on various exchanges.",
  ...
  },
  {
    ...
    subtitle: "budget App",
    image: {
      path: "./images/Budgeteer-mobile.png",
      width: "300",
      height: "450",
      alt: "Budgeteer "
    },
...
const Project = projectsData.map((project) => {
  return (
    <div className="project row flex-lg-row-reverse align-items-center my-5 rounded-5 justify-content-center ">
      <div className="col-10 col-sm-12 col-lg-6 d-flex justify-content-center p-0 px-lg-4  ">
        <img
          className="rounded-5 has-radius d-block mx-lg-auto img-fluid shadow shadow-lg border"
      ...
      <div className=" col-lg-6 mb-5 mt-3">
        <h4 className="text-center display-6 fw-bolder text-info card-title">
          {project.title}
        </h4>
        ...
        <div className="m-3 fs-3 p-2  border border-primary border-2 rounded-5 row">
          <h5 className="m-0 my-2  text-center text-primary ">
            Technologies Used:
          </h5>
...
const Projects = () => {
  return (
    <div className="container-fluid m-auto " id="projects">
      <div className="container-fluid w-100 m-auto bg-oxford has-raduis py-4 my-5">
