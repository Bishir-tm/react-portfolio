      ...
      <div id="foot" className="rounded-pill ">
        <div className="d-flex flex-wrap justify-content-between p-3 py-2">
            ...
            <ul className="nav col-12 justify-content-end list-unstyled d-flex">
              <li>
                <a
                  ...
                  href="https://www.linkedin.com/in/bishir"
                  target="_blank"
                >
                  <svg
              ...
              <li>
                <a
                  className="btn btn-outline-primary rounded-pill"
                  href="https://github.com/bishir-tm"
                  target="_blank"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
              ...
              <li>
                <a
                  className="btn btn-outline-primary rounded-pill"
                  href="https://twitter.com/bishirtm"
                  target="_blank"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
          ...
          <a
            ...
            target="_blank"
            className="text-deocration-none btn btn-lg btn-outline-primary rounded-pill"
          >
            View Resume
          </a>
          <a
      ...
      <div className="container">
        <div className="row">
          ...
          <div className="col-12 col-md-4 border-end d-flex align-items-center justify-content-center ">
            <img
              height={"auto"}
              className="w-75 rounded rounded-circle bg-white"
              src="./b.svg"
              alt=""
            />
          </div>
