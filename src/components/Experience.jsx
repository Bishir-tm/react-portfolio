    ...
    <section className="container-fluid mb-5"  >
      <div  className='experience has-raduis' id="experience">
        <div
          ...
          className="d-flex flex-wrap flex-column bg-oxford has-raduis m-auto has-blur py-5 pt-3"
        >
            ...
            <div className="timeline">
              <div className="timeline-card-container left">
                ...
                >
                  ...
                  <div className="card-body text-dark pt-0">
                    <h4 className="card-subtitle  text-primary">Freelance Web Developer</h4>
                    <p className="card-text text-black">
                      Developing full stack web applications using HTML, 
                      CSS, JS, Bootstrap, ReactJS, PHP, mySQL etc.
                    </p>
                  </div>
                </div>
              </div>
              <div className="timeline-card-container right">
                ...
                >
                  ...
                  <div className="card-body text-dark pt-0">
                    <h4 className="card-title text-oxford fs-6">ISERVNG Technologies</h4>
                    <h5 className="card-subtitle  text-primary">In-House Graphics Designer</h5>
                    <p className="card-text text-black">
                      Responsible for designing their brand identity and 
